...
export default function Pricing() {
  ...
  return (
    <>
      <section
        id="pricing"
        className="relative py-24 bg-background overflow-hidden w-full max-w-full"
      >
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              >
                Simple, <span className="text-text">transparent pricing</span>
              </h2>
              <p
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      <div
                        className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                          plan.highlighted ? 'bg-white/5' : 'bg-black/50'
                        }`}
                      >
                        <Icon
                          className={`w-6 h-6 ${
                            plan.highlighted ? 'text-text' : 'text-text/70'
                          }`}
                        />
                      </div>
                      <div>
                        <h3 className="text-heading md:text-heading-md lg:text-heading-lg font-medium text-text">
                          {plan.name}
                        </h3>
                      </div>
                    </div>
                    ...
                    <div className="mb-6">
                      <div className="flex items-baseline gap-2">
                        <span
                          className={`text-subheading font-medium ${
                      ...
                      <p className="text-base font-extralight text-text/70 mt-2">
                        {plan.description}
                      </p>
                    </div>
                        ...
                        >
                          <div
                            className={`flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center mt-0.5 ${
                              plan.highlighted ? 'bg-white/5' : 'bg-black'
                            }`}
                          >
                            <Check
                              className={`w-3 h-3 ${
                          ...
                          <span className="text-base font-extralight text-text/70 leading-relaxed">
                            {feature}
                          </span>
                        </div>
                      ))}
