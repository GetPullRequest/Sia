      ...
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        <div className="bg-card rounded-2xl shadow-sm p-4 sm:p-6 md:p-8 lg:p-12 space-y-8">
          ...
          <p className="text-text/70 leading-relaxed">
            By accessing or using GetPullRequest ("Service"), you agree to be
            bound by these Terms of Service ("Terms"). If you do not agree to
            these Terms, do not access or use the Service. We reserve the right
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-text/70 leading-relaxed">
                ...
                requirement and have the authority to enter into these Terms.
              </p>
            </div>
          </div>
          ...
          <p className="text-text/70 leading-relaxed mb-4">You agree not to:</p>
          <ul className="list-disc list-inside text-text/70 space-y-2 ml-4">
            <li>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-text/70 leading-relaxed">
                You retain all ownership rights to your code and repositories.
                By using the Service, you grant us a limited license to access,
                process, and modify your code solely to provide the Service.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-text/70 leading-relaxed">
                Code generated by our AI assistant is provided to you under the
                same license as your repository. You are responsible for
                reviewing and testing all generated code before merging.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-text/70 leading-relaxed">
                The Service, including its design, features, algorithms, and all
                related intellectual property, is owned by GetPullRequest and is
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-text/70 leading-relaxed">
                The Service is offered through various subscription plans. You
                agree to pay all fees associated with your selected plan. Fees
            ...
            <div>
              ...
              <p className="text-text/70 leading-relaxed">
                ...
                provide refunds for partial months or unused services, except as
                required by law.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-text/70 leading-relaxed">
                We reserve the right to change our pricing. We will provide
                reasonable notice of any price increases, and you will have the
                opportunity to cancel before the new prices take effect.
              </p>
            </div>
          </div>
          ...
          <p className="text-text/70 leading-relaxed mt-4">
            You are responsible for reviewing, testing, and validating all code
            generated by the Service before deployment.
          </p>
          ...
          <p className="text-text/70 leading-relaxed">
            You agree to indemnify and hold harmless GetPullRequest, its
          ...
          <p className="text-text/70 leading-relaxed">
            The Service integrates with third-party platforms (e.g., GitHub,
            Slack, Discord). Your use of these integrations is subject to the
            respective third party's terms and policies. We are not responsible
            for the availability, content, or practices of these third-party
            services.
          </p>
          ...
          <p className="text-text/70 leading-relaxed mb-4">
            ...
            with or without cause, including if:
          </p>
          <ul className="list-disc list-inside text-text/70 space-y-2 ml-4">
          ...
          <p className="text-text/70 leading-relaxed">
            ...
            GetPullRequest is registered, without regard to conflict of law
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-text/70 leading-relaxed">
                ...
                entire agreement between you and GetPullRequest regarding the
                Service.
              </p>
            </div>
          ...
          <div className="mt-4 p-4 bg-card rounded-lg">
            <p className="text-text font-medium">
              Email: legal@getpullrequest.com
            </p>
            <p className="text-text/70 mt-1">
              Support: support@getpullrequest.com
            </p>
          </div>
        </div>
      </div>
