      ...
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        <div className="bg-card rounded-2xl shadow-sm p-4 sm:p-6 md:p-8 lg:p-12 space-y-8">
          ...
          <p className="text-text/70 leading-relaxed break-words">
            GetPullRequest ("we," "our," or "us") is committed to protecting
          ...
          <ul className="list-disc list-inside text-text/70 space-y-2 ml-4">
            <li>
              Provide, maintain, and improve our AI development assistant
              service
            </li>
            <li>
              Generate pull requests and implement code changes as requested
            </li>
          ...
          <p className="text-text/70 leading-relaxed">
            ...
            needed, unless we are required to retain it for legal or compliance
            purposes.
          </p>
          ...
          <p className="text-text/70 leading-relaxed">
            Our service integrates with third-party platforms (e.g., GitHub,
            Slack, Discord). When you connect these integrations, you authorize
            us to access certain information from these platforms as permitted
            by their terms and your privacy settings. We recommend reviewing the
          ...
          <div className="mt-4 p-4 bg-card rounded-lg">
            <p className="text-text font-medium">
              Email: privacy@getpullrequest.com
            </p>
