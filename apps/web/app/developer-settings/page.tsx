  ...
  const createMutation = useMutation({
    ...
    onSuccess: (data) => {
      if (!data || !data.apiKey) {
        toast({
          title: 'Error',
          description: 'API key was created but the response format was unexpected',
          variant: 'destructive',
        })
        return
      }
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className="mt-2">
                API keys allow you to authenticate requests to the Sia API. Keep your keys secure and never share them publicly.
              </CardDescription>
            </div>
      ...
      <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Enter a name to identify this API key. You&apos;ll be able to copy the key after creation.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div>
              <label htmlFor="api-key-name" className="text-sm font-medium mb-2 block">
                Name
              </label>
              <Input
                id="api-key-name"
          ...
          <DialogFooter>
            ...
            <Button onClick={handleCreate} disabled={creating || !apiKeyName.trim()}>
