  ...
  useEffect(() => {
    ...
    const processCallback = async () => {
      ...
      try {
        ...
        setStatus('error')
        const message = error instanceof Error ? error.message : 'Failed to process GitHub installation'
      ...
      <div className="text-center space-y-4">
        ...
        {status === 'success' && (
          <>
            ...
            <p className="text-lg text-green-600">GitHub integration connected successfully!</p>
