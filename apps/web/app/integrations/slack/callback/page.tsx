  ...
  useEffect(() => {
    ...
    const processCallback = async () => {
      ...
      try {
        ...
        setStatus('error')
        const message = error instanceof Error ? error.message : 'Failed to process Slack OAuth callback'
      ...
      <div className="text-center space-y-4">
        ...
        {status === 'success' && (
          <>
            ...
            <p className="text-lg text-green-600">Slack integration connected successfully!</p>
        ...
        {status === 'error' && (
          <>
            ...
            <p className="text-sm text-gray-400">Redirecting to integrations page...</p>
          </>
        )}
      </div>
    </div>
