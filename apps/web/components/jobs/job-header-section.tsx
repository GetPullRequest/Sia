...
import { statusColors, acceptanceStyles, formatRelativeTime } from './job-constants'
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap items-center gap-3 mt-3 text-sm text-muted-foreground">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        {selectedProviderId ? (
                                            <select
                                                ...
                                                onChange={(e) => onEditFormChange('repo_name', e.target.value)}
                                ...
                                {(isEditMode || (job.status === 'queued' && job.order_in_queue !== undefined)) && (
                                    <>
                                        <Separator orientation="vertical" className="h-4" />
                                        {isEditMode ? (
                                            <div className="flex items-center gap-2">
                                                ...
                                                <Input
                                                    ...
                                                    onChange={(e) => onEditFormChange('order_in_queue', e.target.value)}
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    {job.status === 'in-review' && (
                        <Badge className={cn('capitalize', acceptanceStyles[acceptanceStatus as keyof typeof acceptanceStyles])}>
