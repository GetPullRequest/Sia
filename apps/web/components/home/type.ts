...
export const LANE_DEFINITIONS: LaneDefinition[] = [
  {
    ...
    title: 'Queue',
    subtitle: 'Queue',
    emptyState: 'Nothing waiting here. Add a task and Sia will take it from there.',
  },
  {
    id: 'in-progress',
    title: 'In Progress',
    subtitle: 'Execution',
    emptyState: 'No active jobs right now. Sia is not working on anything at the moment.',
  },
  {
    id: 'in-review',
    title: 'In Review',
  ...
  },
  {
    ...
    title: 'Completed',
    subtitle: 'Shipped',
    emptyState: 'Nothing shipped yet. Sia has not completed any tasks at the moment.',
  },
  {
    id: 'failed',
    title: 'Error',
    subtitle: 'Errors',
    emptyState: 'No failed jobs. Sia has not encountered any errors at the moment.',
  },
]
