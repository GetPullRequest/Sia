...
export function QueueSelectionDialog({
  open,
  pendingQueueMove,
  onSelect,
  onClose,
}: QueueSelectionDialogProps) {
  return (
    <Dialog
      open={open}
      onOpenChange={isOpen => {
    ...
    >
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Where would you like to move "{pendingQueueMove?.job.generated_name}
            "?
          </DialogDescription>
        </DialogHeader>
        <div className="flex flex-col gap-3 py-4">
          <Button
            onClick={() => onSelect('rework')}
            variant="outline"
          ...
          >
            <div className="text-left">
              ...
              <div className="text-sm text-muted-foreground">
                For jobs that need to be reworked
              </div>
            </div>
          </Button>
          <Button
          ...
          >
            <div className="text-left">
              ...
              <div className="text-sm text-muted-foreground">
                For new or regular queued jobs
              </div>
            </div>
          </Button>
        </div>
