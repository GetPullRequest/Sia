...
export function registerSchemas(fastify: FastifyInstance) {
  ...
  fastify.addSchema({ $id: 'ConnectGitHubRequest', ...ConnectGitHubRequestSchema });
  fastify.addSchema({ $id: 'ConnectGitHubCallbackRequest', ...ConnectGitHubCallbackRequestSchema });
  fastify.addSchema({ $id: 'ConnectPATRequest', ...ConnectPATRequestSchema });
  fastify.addSchema({ $id: 'DisconnectProviderResponse', ...DisconnectProviderResponseSchema });
  fastify.addSchema({ $id: 'GetReposResponse', ...GetReposResponseSchema });
  fastify.addSchema({ $id: 'CreateActivityRequest', ...CreateActivityRequestSchema });
  fastify.addSchema({ $id: 'UpdateActivityRequest', ...UpdateActivityRequestSchema });
  fastify.addSchema({ $id: 'UpdateActivityReadStatusRequest', ...UpdateActivityReadStatusRequestSchema });
  fastify.addSchema({ $id: 'UpdateActivityReadStatusResponse', ...UpdateActivityReadStatusResponseSchema });
  fastify.addSchema({ $id: 'Activity', ...ActivitySchema });
  fastify.addSchema({ $id: 'IntegrationResponse', ...IntegrationResponseSchema });
  fastify.addSchema({ $id: 'ReprioritizeJobRequest', ...ReprioritizeJobRequestSchema });
  fastify.addSchema({ $id: 'ReprioritizeJobResponse', ...ReprioritizeJobResponseSchema });
  ...
  fastify.addSchema({ $id: 'StoreIntegrationSecretRequest', ...StoreIntegrationSecretRequestSchema });
  fastify.addSchema({ $id: 'StoreIntegrationSecretResponse', ...StoreIntegrationSecretResponseSchema });
  fastify.addSchema({ $id: 'GetIntegrationSecretResponse', ...GetIntegrationSecretResponseSchema });
  fastify.addSchema({ $id: 'GetIntegrationSecretPlaintextResponse', ...GetIntegrationSecretPlaintextResponseSchema });
  fastify.addSchema({ $id: 'CreateApiKeyRequest', ...CreateApiKeyRequestSchema });
  fastify.addSchema({ $id: 'CreateApiKeyResponse', ...CreateApiKeyResponseSchema });
