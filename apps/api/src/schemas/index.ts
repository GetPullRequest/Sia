...
export const UserInputSchema = Type.Object({
  ...
  prompt: Type.String(),
  sourceMetadata: Type.Optional(Type.Union([
    Type.Object({
...
export const UpdateJobRequestSchema = Type.Object({
  ...
  queue_type: Type.Optional(Type.Union([Type.Literal('rework'), Type.Literal('backlog')])),
}, { additionalProperties: false });
...
export const JobSchema = Type.Object({
  ...
  queue_type: Type.Optional(Type.Union([
    Type.Literal('rework'),
...
export const StoreIntegrationSecretRequestSchema = Type.Object({
  providerType: Type.String({ description: 'The type of integration provider (e.g., cursor, claude-code, kiro-cli)' }),
  name: Type.String({ description: 'A short description/label to help identify the key' }),
...
export const CreateApiKeyResponseSchema = Type.Object({
  ...
  apiKey: Type.String({ description: 'The full API key (only shown once on creation)' }),
  createdAt: Type.String({ format: 'date-time' }),
}, { additionalProperties: false });
...
export type ConnectGitHubRequestType = Static<typeof ConnectGitHubRequestSchema>;
export type ConnectGitHubCallbackRequestType = Static<typeof ConnectGitHubCallbackRequestSchema>;
export type ConnectPATRequestType = Static<typeof ConnectPATRequestSchema>;
export type DisconnectProviderResponseType = Static<typeof DisconnectProviderResponseSchema>;
export type GetReposResponseType = Static<typeof GetReposResponseSchema>;
export type CreateActivityRequestType = Static<typeof CreateActivityRequestSchema>;
export type UpdateActivityRequestType = Static<typeof UpdateActivityRequestSchema>;
...
export type ReprioritizeJobRequestType = Static<typeof ReprioritizeJobRequestSchema>;
export type ReprioritizeJobResponseType = Static<typeof ReprioritizeJobResponseSchema>;
...
export type StoreIntegrationSecretRequestType = Static<typeof StoreIntegrationSecretRequestSchema>;
export type StoreIntegrationSecretResponseType = Static<typeof StoreIntegrationSecretResponseSchema>;
export type GetIntegrationSecretResponseType = Static<typeof GetIntegrationSecretResponseSchema>;
export type GetIntegrationSecretPlaintextResponseType = Static<typeof GetIntegrationSecretPlaintextResponseSchema>;
