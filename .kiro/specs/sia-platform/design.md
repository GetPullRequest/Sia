...
_For any_ job in the system, the job status SHALL be one of: draft, queued, in-progress, in-review, completed, failed.
**Validates: Requirements 2.4, 7.1**

### Property 2: Queue Order Preservation

_For any_ set of jobs in a queue, jobs SHALL be processed in ascending orderInQueue order.
**Validates: Requirements 7.2**

### Property 3: Agent Assignment Exclusivity

_For any_ agent at any point in time, the agent SHALL have at most one job in-progress.
**Validates: Requirements 7.3**

### Property 4: Real-time Update Delivery

_For any_ job status change or log message, all subscribed WebSocket clients SHALL receive the update.
**Validates: Requirements 8.1, 8.2**

### Property 5: Authentication Enforcement

_For any_ API request to protected endpoints, the system SHALL verify authentication before processing.
